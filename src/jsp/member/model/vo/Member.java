...
public class Member implements java.io.Serializable {
	...
	public Member(int uno, String userId, String userPwd, String nickName, String phone, String email, String address,
			String interest, Date enorollDate, Date modifyDate, String status) {
		super();
		this.uno = uno;
		this.userId = userId;
	...
	public Date getEnorollDate() {
		return enorollDate;
	}

	public void setEnorollDate(Date enorollDate) {
		this.enorollDate = enorollDate;
	}
	...
	public String toString() {
		return "Member [uno=" + uno + ", userId=" + userId + ", userPwd=" + userPwd + ", nickName=" + nickName
				...
				+ ", enorollDate=" + enorollDate + ", modifyDate=" + modifyDate + ", status=" + status + "]";
	}
